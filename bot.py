...
# ==================== ОНОВЛЕНИЙ ТОКЕН ====================
TOKEN = "8804498885:AAFoDtZ5Vj9U03lu05p2GWQBiUOkqA0ZJ6E"
...
# --- ФЕЙКОВИЙ ВЕБ-СЕРВЕР ТА ТОЧКА ВХОДУ ---
...
async def main():
    ...
    # 1. Сначала запускаем веб-сервер, чтобы Render мгновенно прошел Port Scan
    await start_web_server()
    
    # 2. Очищаем вебхуки и запускаем Long Polling
